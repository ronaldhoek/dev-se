...
JPEGOptimizeSize:integer = 250;JPEGProgressiveMode:boolean=false;JPEGOptimizeMode:boolean=false;
JPEGCompression:integer=85);
...
begin
  ...
  begin
    OptimizeToSize := JPEGOptimizeSize * 1024;
    Progressive := JPEGProgressiveMode;

    if JPEGOptimizeMode then
