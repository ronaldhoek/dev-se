...
{ To add support for a different MakerNote format, you need to write a descendent of
  ...
  public
    ...
    property MPOData: IMetadataBlock read FICCData;
    property MPOBlockOffset: Int64 read FICCSegmentPosition;
    //MPO SUPPORT END
...
function TCustomExifData.HasICCProfile: Boolean;
var
  Words: PWordArray;
begin
...
function TCustomExifData.ExtractICCProfile(Stream: TStream): Boolean;
begin
...
begin
  ...
  if (FICCData <> nil) and (FICCData.Data <> nil) then
    Result := PAnsiChar(FICCData.Data.Memory) = 'MPF';
end;
