...
type
  TChromium = class(TComponent, IChromiumEvents)
    ...
    public
      ...
      function    CreateBrowser(const aBrowserParent : TCEFWinControl = nil; const aWindowName : ustring = ''; const aContext : ICefRequestContext = nil; const aCookiesPath : ustring = ''; aPersistSessionCookies : boolean = False) : boolean; overload; virtual;
...
function TChromium.CreateBrowser(const aBrowserParent         : TCEFWinControl;
