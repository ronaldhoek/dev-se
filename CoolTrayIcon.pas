...
procedure TCoolTrayIcon.SetText(const Value: string);
begin
  FText := Value;
end;

procedure TCoolTrayIcon.SetTimeout(const Value: Integer);
begin
  FTimeout := Value;
end;

procedure TCoolTrayIcon.SetTitle(const Value: string);
begin
  FTitle := Value;
end;
...
procedure TCoolTrayIcon.SetFlag(const Value: Integer);
begin
  FFlag := Value;
end;
